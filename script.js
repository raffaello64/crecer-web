const sections = {
  "Home": `
    <h2>Bienvenidos a Crecer Explorar Crecer</h2>
    <p>Centro educativo dedicado al aprendizaje con amor y creatividad. Explora nuestras secciones para conocer más sobre nosotros.</p>

    <!-- Embed de Instagram -->
    <blockquote class="instagram-media" 
        data-instgrm-permalink="https://www.instagram.com/p/DOhFztyDdsi/" 
  ...
  "Contacto": "Dirección: CLL 18 NO 10B - 36, Magangué, Bolívar<br>Tel: +573003845122<br>Email: ceducrecerex@gmail.com",
...
Object.keys(sections).forEach((sectionName, index) => {
  ...
  li.addEventListener("click", () => {
    content.innerHTML = sections[sectionName]; // <- actualizar contenido
